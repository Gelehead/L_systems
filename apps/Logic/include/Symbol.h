...
namespace grammar
{
    ...
    public:
        ...
        bool isTerminal() override { return next.empty(); }
        ...
        std::vector<std::vector<Constituent *>> getNextElements(Seed seed) const override
        {
            return next;
        }
        ...
        // I think it was necessary for the equality overload to work
